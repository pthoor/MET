...
Per Microsoft's own published Default/Standard/Strict quarantine-policy matrix (verified against [Recommended email and collaboration threat policy settings](https://learn.microsoft.com/en-us/defender-office-365/recommended-settings-for-eop-and-office365); see `docs/gap-analysis-2026-08-quarantine-policies.md` for the full table), only **two** verdicts have an actual restrictive floor - a case where Microsoft's own Strict preset uses `AdminOnlyAccessPolicy` (no self-release):
...
- `docs/gap-analysis-2026-08-quarantine-policies.md` - verified verdict/quarantine-policy matrix and bug analysis
