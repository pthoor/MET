...
$METCheckInfo = @{
    Name           = 'Anti-Spam Outbound Effective Coverage'
    Severity       = 'High'
    Description    = 'Resolves the effective outbound anti-spam policy per mailbox and checks auto-forward restrictions, sending limits, and external forwarding rules.'
